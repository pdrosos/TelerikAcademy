...
public class Worker : Human
{
    ...
    public Worker(string firstName, string secondName, int weekweekSalary, int workHoursPerDay)
    ...
    public int WorkHoursPerDay
    {
        ...
        set
        {
            if (value <= 0)
            {
                throw new ArgumentException("Work hours cannot be a negative number!");
            }
