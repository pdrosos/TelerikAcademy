...
namespace GeometryAPI
{
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        public double GetArea()
        {
            ...
            double TopAndBottom = baseArea * 2;
    ...
    public class AdvancedFigureControler : FigureController
    {
        ...
        protected override void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            switch (splitCommand[0])
            {
                case "area":
                    {
                        var currentAsIAriaMeasurable = this.currentFigure as IAreaMeasurable;
                        if (currentAsIAriaMeasurable !=null)
                        {
                            Console.WriteLine("{0:0.00}", currentAsIAriaMeasurable.GetArea());
                        }
                        break;
                    }
            }
...
namespace AcademyGeometry
{
    class Program
    {
        ...
        {
            return new AdvancedFigureControler();
        }
