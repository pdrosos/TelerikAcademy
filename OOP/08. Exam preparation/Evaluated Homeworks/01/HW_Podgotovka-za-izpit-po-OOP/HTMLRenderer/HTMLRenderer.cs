...
namespace HTMLRenderer
{
    ...
    public class HtmlTable : HtmlElement, ITable
    {
            ...
            : base(TableName)
        {
            this.Rows = rows;
            this.Cols = cols;
            this.sells = new IElement[this.Rows, this.Cols];
        }
        ...
        public IElement this[int row, int col]
        {
            ...
            set
            {
                ...
                if (value == null)
                {
                    throw new ArgumentNullException("value", "HTML element in table sell cannot be null");
                }
                this.sells[row, col] = value;
            }
        }
        ...
        public override string TextContent
        {
            get
            {
                throw new InvalidOperationException("Cannot get text content of HTML tables!");
            }
            set
            {
                throw new InvalidOperationException("Cannot set text content of HTML tables!");
            }
        }
        ...
        {
            throw new InvalidOperationException("HTML table do not have child elements so such cannot be added");
        }
        ...
        public override void Render(StringBuilder output)
        {
            ...
            for (int row = 0; row < this.Rows; row++)
            {
                ...
                for (int col = 0; col < this.Cols; col++)
                {
                    ...
                    output.Append(this.sells[row, col].ToString());
