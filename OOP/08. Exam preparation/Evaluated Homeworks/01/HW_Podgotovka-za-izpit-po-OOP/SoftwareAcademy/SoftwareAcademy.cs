    ...
    public abstract class Course : ICourse
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                if (string.IsNullOrWhiteSpace(value))
                {
                    throw new ArgumentOutOfRangeException("Course name cannot be empty string or a sequence of white spaces!");
                }
    ...
    public class OffsiteCourse : Course, IOffsiteCourse
    {
        ...
        public string Town
        {
            ...
            set
            {
                if (value == null)
                {
                    throw new ArgumentNullException("value", "Offsite course laboratory cannot be null!");
                }
                if (string.IsNullOrWhiteSpace(value))
                {
                    throw new ArgumentOutOfRangeException("Offsite course laboratory cannot ne empty!");
                }
                this.town = value;
            }
        }
