...
INSERT INTO Authors(AuthorName) VALUES ('George Georgiev')
...
SELECT COUNT(*) FROM Authors AS AuthorsCount
...
SELECT * FROM Messages
WHERE MsgDate > '31-Dec-2011' and MsgDate < '1-Jan-2012'
...
AND MsgDate > '31-Dec-2011' and MsgDate < '1-Jan-2012'
...
CREATE INDEX IDX_Messages_MsgDateMsgPrice ON Messages(MsgPrice) INCLUDE (AuthorID)
...
CREATE INDEX IDX_Messages_MsgPriceMsgDate ON Messages(MsgPrice, MsgDate)
...
CREATE INDEX IDX_Messages_MsgText ON Messages(MsgText)
