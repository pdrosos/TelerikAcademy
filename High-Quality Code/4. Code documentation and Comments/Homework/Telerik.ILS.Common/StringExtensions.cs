...
namespace Telerik.ILS.Common
{
    ...
    /// <summary>
    /// Contains extension methods for the <see cref="System.String"/>
    /// </summary>
    public static class StringExtensions
    {
        ...
        /// <summary>
        /// Converts a the given string to a <see cref="System.Boolean"/> if possible
        /// </summary>
        ...
        /// </summary>
        /// <param name="input">The input cyrillic string</param>
        ...
        /// <returns>Returns a the cyrillic string representation of the given <paramref name="input"/></returns>
        ...
        /// <returns>Returns a valid file name</returns>
        ...
        /// <summary>
        /// Gets the given amount of characters from a string
        /// </summary>
        /// <param name="input">Input string</param>
        /// <param name="charsCount">Given character count to get</param>
        /// <returns>Returns the given amount of characters</returns>
        ...
        /// <summary>
        /// Gets the extension form a given file name
        /// </summary>
        /// <param name="fileName">The input file name</param>
        /// <returns>Returns the extension of the file</returns>
        ...
        /// <summary>
        /// Converts a given sting file extension to a content type
        /// </summary>
